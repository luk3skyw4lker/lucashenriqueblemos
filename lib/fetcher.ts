...
const libraries = ['bit-macros', 'node-ntp-sync', 'heatmap-pkg'];
...
export const getUserRepos = async () => {
	...
	const languages = return_repos.map(repo => new Promise((resolve, reject) => {
		fetch(`https://api.github.com/repos/luk3skyw4lker/${repo.name}/languages`, fetch_config)
